        ...
        !(function () {
            ...
            (c.prototype.buildTemplates = function () {
                ...
                //this.core.s.flipHorizontal && (a += '<button aria-label="Flip horizontal" class="lg-flip-hor lg-icon"></button>'),
                    ...
                    //.core.$outer.find(".lg-toolbar").append(a);
            }),
                (c.prototype.init = function () {
                    var a = this;
                    this.buildTemplates(),
                ...
                (c.prototype.applyStyles = function () {
                    this.core.$slide
                        ...
                        .css(
                            "transform",
                            "rotate(" + this.rotateValuesList[this.core.index].rotate + "deg) scale3d(" + this.rotateValuesList[this.core.index].flipVertical + ", " + this.rotateValuesList[this.core.index].flipHorizontal + ", 1)"
                        );
                }),
